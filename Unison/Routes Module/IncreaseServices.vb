...
Public Class IncreaseServices
    ...
    Dim SQLSelect As String = _
            ...
            " , (SELECT isnull(sum((1+irax.rate/100)*asvc.Charge), 0.00) FROM " & ROUTESTblPath & "AccountServices asvc, IncreaseRatesAcct irax WHERE irax.applied = 0 AND irax.AccountID = c.ID AND irax.AccountID = asvc.AccountID AND asvc.Enddate is null ) as [NCost] " & _
