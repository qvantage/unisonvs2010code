...
Public Class RouteSheetReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RoutesModule.RouteSheetReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRouteSheetReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RouteSheetReport = New RouteSheetReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
