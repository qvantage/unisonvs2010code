...
Public Class MiscIncomeSetup
    Inherits System.Windows.Forms.Form
    Public SQLSelect As String = "Select MiscIncomeID, MiscIncomeName, Active From " & HRTblPath & "MISCINCOME ORDER BY MiscIncomeID"
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents utMiscIncName As Infragistics.Win.UltraWinEditors.UltraTextEditor
    Friend WithEvents utMiscIncID As Infragistics.Win.UltraWinEditors.UltraTextEditor
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.utMiscIncName = New Infragistics.Win.UltraWinEditors.UltraTextEditor
        Me.utMiscIncID = New Infragistics.Win.UltraWinEditors.UltraTextEditor
        Me.GroupBox4.SuspendLayout()
        CType(Me.UltraGrid1, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.utMiscIncName, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.utMiscIncID, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'GroupBox4
        '
        ...
        'UltraGrid1
        '
        Me.UltraGrid1.Location = New System.Drawing.Point(0, 60)
        Me.UltraGrid1.Name = "UltraGrid1"
        Me.UltraGrid1.Size = New System.Drawing.Size(376, 200)
        Me.UltraGrid1.TabIndex = 2
        Me.UltraGrid1.Text = "Miscellaneous Incomes"
        '
        'Label2
        '
        ...
        Me.utMiscIncName.Appearance = Appearance1
        Me.utMiscIncName.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper
        Me.utMiscIncName.Location = New System.Drawing.Point(104, 28)
        Me.utMiscIncName.Name = "utMiscIncName"
        Me.utMiscIncName.Size = New System.Drawing.Size(200, 21)
        Me.utMiscIncName.TabIndex = 1
        Me.utMiscIncName.Tag = ".MiscIncomeName"
        '
        'utMiscIncID
        '
        Appearance2.ForeColor = System.Drawing.Color.Black
        Appearance2.ForeColorDisabled = System.Drawing.Color.Black
        Me.utMiscIncID.Appearance = Appearance2
        Me.utMiscIncID.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper
        Me.utMiscIncID.Location = New System.Drawing.Point(104, 4)
        Me.utMiscIncID.Name = "utMiscIncID"
        Me.utMiscIncID.Size = New System.Drawing.Size(100, 21)
        Me.utMiscIncID.TabIndex = 0
        Me.utMiscIncID.Tag = ".MiscIncomeID.VIEW"
        '
        'MiscIncomeSetup
        '
        ...
        Me.Controls.Add(Me.utMiscIncName)
        Me.Controls.Add(Me.utMiscIncID)
        Me.Name = "MiscIncomeSetup"
        Me.Tag = "MISCINCOME"
        Me.Text = "Miscellaneous Income Setup"
        Me.GroupBox4.ResumeLayout(False)
        CType(Me.UltraGrid1, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.utMiscIncName, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.utMiscIncID, System.ComponentModel.ISupportInitialize).EndInit()
        Me.ResumeLayout(False)

    End Sub

#End Region
    Private Sub MiscIncomeSetup_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Group_EnDis(ByVal status As Boolean)
        ...
        utMiscIncID.Enabled = status
        utMiscIncName.Enabled = status
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        '        Exit Sub
        '    End If
        If utMiscIncName.Text.Trim = "" Then
            MsgBox("Enter Miscellaneous Income Name.")
            Exit Sub
        End If
        'End If
        ...
        If Not UltraGrid1.ActiveRow Is Nothing Then
            IdxName = " Where MiscIncomeID = '" & UltraGrid1.ActiveRow.Cells("MiscIncomeID").Value & "'"
    ...
    Private Sub BtnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        ...
        If sender.text.toupper = "&EDIT" Then
            ...
            If EditForm(Me, PrepSelectQuery(SQLSelect, " Where MiscIncomeID = '" & UltraGrid1.ActiveRow.Cells("MiscIncomeID").Value.ToString.Trim & "'"), EditAction.START, cmdTrans) Then
