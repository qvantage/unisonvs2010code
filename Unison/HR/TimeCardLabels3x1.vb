...
Public Class TimeCardLabels3x1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RoutesModule.TimeCardLabels3x1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_p_payrollEndDate() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedTimeCardLabels3x1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TimeCardLabels3x1 = New TimeCardLabels3x1()
        rpt.Site = Me.Site
        Return rpt
    End Function
