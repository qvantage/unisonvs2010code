...
Public Class TimeCardLabels2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RoutesModule.TimeCardLabels2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTimeCardLabels2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TimeCardLabels2 = New TimeCardLabels2()
        rpt.Site = Me.Site
        Return rpt
    End Function
