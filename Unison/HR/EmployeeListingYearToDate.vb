...
Public Class EmployeeListingYearToDate
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupBox1.Controls.Add(Me.uopRepStyle)
        Me.GroupBox1.Dock = System.Windows.Forms.DockStyle.Top
        Me.GroupBox1.Location = New System.Drawing.Point(0, 0)
        Me.GroupBox1.Name = "GroupBox1"
        Me.GroupBox1.Size = New System.Drawing.Size(808, 200)
        Me.GroupBox1.TabIndex = 1
        Me.GroupBox1.TabStop = False
        '
        'uchExpand
        '
        Me.uchExpand.Location = New System.Drawing.Point(88, 168)
        Me.uchExpand.Name = "uchExpand"
        Me.uchExpand.Size = New System.Drawing.Size(131, 20)
        Me.uchExpand.TabIndex = 5
        Me.uchExpand.Text = "Expand Rows"
        '
        'GroupBox5
        '
        Me.GroupBox5.Controls.Add(Me.ulblTo)
        Me.GroupBox5.Controls.Add(Me.udtTo)
        Me.GroupBox5.Controls.Add(Me.udtFrom)
        Me.GroupBox5.Controls.Add(Me.uopDate)
        Me.GroupBox5.Location = New System.Drawing.Point(456, 17)
        Me.GroupBox5.Name = "GroupBox5"
        Me.GroupBox5.Size = New System.Drawing.Size(344, 72)
        ...
        Me.uopRepStyle.Location = New System.Drawing.Point(8, 168)
        Me.uopRepStyle.Name = "uopRepStyle"
        Me.uopRepStyle.Size = New System.Drawing.Size(66, 24)
        Me.uopRepStyle.TabIndex = 4
        Me.uopRepStyle.Visible = False
        '
        'btnExcel
        '
        Me.btnExcel.Location = New System.Drawing.Point(712, 168)
        ...
        'btnPrint
        '
        Me.btnPrint.Location = New System.Drawing.Point(624, 168)
        ...
        'btnDisplay
        '
        Me.btnDisplay.Location = New System.Drawing.Point(536, 168)
        ...
        ValueListItem2.DataValue = "All Offices"
        ValueListItem2.DisplayText = "All Offices"
        ValueListItem3.DataValue = "By Office"
        ValueListItem3.DisplayText = "By Office"
        ...
        ValueListItem4.DataValue = "All Companies"
        ValueListItem4.DisplayText = "All Companies"
        ValueListItem5.DataValue = "By Company"
        ValueListItem5.DisplayText = "By Company"
        ...
        ValueListItem6.DataValue = "All Employees"
        ValueListItem6.DisplayText = "All Employees"
        ValueListItem7.DataValue = "By Employee"
        ValueListItem7.DisplayText = "By Employee"
        ...
        Me.UltraGrid1.Size = New System.Drawing.Size(808, 317)
        ...
        Me.uopDate.Appearance = Appearance14
        Me.uopDate.BorderStyle = Infragistics.Win.UIElementBorderStyle.None
        Me.uopDate.ItemAppearance = Appearance15
        ValueListItem8.DataValue = "Date Range"
        ValueListItem8.DisplayText = "Date Range"
        Me.uopDate.Items.Add(ValueListItem8)
        Me.uopDate.ItemSpacingVertical = 9
        Me.uopDate.Location = New System.Drawing.Point(8, 15)
        Me.uopDate.Name = "uopDate"
        Me.uopDate.Size = New System.Drawing.Size(80, 25)
        Me.uopDate.TabIndex = 0
        '
        'ulblTo
        '
        Appearance16.TextHAlign = Infragistics.Win.HAlign.Right
        Appearance16.TextVAlign = Infragistics.Win.VAlign.Middle
        Me.ulblTo.Appearance = Appearance16
        Me.ulblTo.Location = New System.Drawing.Point(185, 20)
        Me.ulblTo.Name = "ulblTo"
        Me.ulblTo.Size = New System.Drawing.Size(24, 16)
        Me.ulblTo.TabIndex = 157
        Me.ulblTo.Text = "To"
        '
        'udtTo
        '
        Me.udtTo.DateTime = New Date(2006, 4, 6, 0, 0, 0, 0)
        Me.udtTo.Location = New System.Drawing.Point(228, 16)
        Me.udtTo.Name = "udtTo"
        ...
        Me.Name = "EmployeeListingYearToDate"
        Me.Tag = "EmployeeListingYearToDate"
        Me.Text = "Employee Year-To-Date Listing"
...
#End Region
    ...
    Private Sub EmployeeListingYearToDate_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        uopDate.CheckedIndex = 0 'Date Range

        udtFrom.Nullable = True
        udtFrom.Value = "01/01/" & CStr(DatePart(DateInterval.Year, Date.Today)) 'DateAdd(DateInterval.Day, -1, Date.Today)
        udtFrom.FormatString = "MM/dd/yyyy"

        udtTo.Nullable = True
        udtTo.Value = Date.Today 'DateAdd(DateInterval.Day, -1, Date.Today)
        udtTo.FormatString = "MM/dd/yyyy"
...
ErrTrap:
    ...
    Private Sub LoadData()
        ...
        Dim i As Integer
        Dim SQLSelect, DateRngCond, DateRngCondEMC, DateRngCondEA2, EmplCond, CompCond, OfficeCond, SummCol As String
        Dim sqlEmployee, sqlPayRates, sqlDeductions As String

        SQLSelect = "SELECT ea.EmployeeID " & _
                    ", (SELECT rtrim(FirstName) + ' ' + rtrim(LastName) AS Expr1 FROM " & HRTblPath & "EmployeesBase AS eb WHERE (ID = ea.EmployeeID)) AS Employee_Name " & _
                    ", ea.OfficeID, ea.Office, ea.DeptNo, SUM(ea.HrsPay) AS Total_Paid_Hours" & _
                    ", SUM(ea.AutoPay) AS Total_Paid_Auto, SUM(ea.FuelSurcharge) AS Total_FuelSur " & _
                    ", isnull((Select SUM(emc.Amount) FROM " & HRTblPath & "EMPLOYEEMISCCHARGES AS emc WHERE emc.EmployeeID = ea.EmployeeID and (emc.Type = 'I') AND (emc.Taxable = 1) AND @DATECOND2 AND " & _
                    " (convert(varchar, ea.Employeeid)+'-'+Convert(varchar,ea.OfficeID)+'-'+ea.DeptNo) = " & _
                    "    (Select Min(convert(varchar, ea2.Employeeid)+'-'+Convert(varchar,ea2.OfficeID)+'-'+ea2.DeptNo) FROM " & HRTblPath & "EMPLOYEEACTIVITY ea2 where ea2.employeeid = ea.employeeid and @DATECOND3 Group By ea.EmployeeID, ea.OfficeID, ea.DeptNo) " & _
                    "   ), '0') AS Total_Paid_Misc_Taxable " & _
                    " FROM " & HRTblPath & "EMPLOYEEACTIVITY AS ea " & _
                    " Left Outer Join " & HRTblPath & "EmployeesBase eb on ea.EmployeeID = eb.ID " & _
                    " WHERE @DATECOND1 @EMPLID @COMP @OFFICE " & _
                    " GROUP BY ea.EmployeeID, ea.OfficeID, ea.Office, ea.DeptNo " & _
                    " ORDER BY ea.EmployeeID, ea.OfficeID, ea.Office, ea.DeptNo "

        Select Case uopDate.CheckedIndex
            Case 0 ' Date Range
                DateRngCond = " ea.Payrolldate between '" & udtFrom.Text & "' AND '" & udtTo.Text & "' "
                DateRngCondEMC = " emc.Payrolldate between '" & udtFrom.Text & "' AND '" & udtTo.Text & "' "
                DateRngCondEA2 = " ea2.Payrolldate between '" & udtFrom.Text & "' AND '" & udtTo.Text & "' "
        End Select

        Select Case uopEmployee.CheckedIndex
            Case 0 'All Employees
                EmplCond = " AND ea.EmployeeID like '%' "
            Case 1 'By Employee
        ...
        Select Case uopRepStyle.CheckedIndex
            Case 0 ' AIO
                SQLSelect = SQLSelect.Replace("@DATECOND3", DateRngCondEA2)
                SQLSelect = SQLSelect.Replace("@DATECOND2", DateRngCondEMC)
                SQLSelect = SQLSelect.Replace("@DATECOND1", DateRngCond)
