...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'GroupBox2
        '
        Me.GroupBox2.Controls.Add(Me.utRoute)
        ...
        Me.utRoute.Location = New System.Drawing.Point(112, 39)
        Me.utRoute.Name = "utRoute"
        Me.utRoute.Size = New System.Drawing.Size(104, 21)
        Me.utRoute.TabIndex = 151
        Me.utRoute.Tag = ".EmployeeID"
        '
        'ucboOffice
        '
        ...
        ValueListItem4.DataValue = "By Route"
        ValueListItem4.DisplayText = "By Route"
        ...
        Me.UltraGrid1.Size = New System.Drawing.Size(953, 340)
        Me.UltraGrid1.TabIndex = 5
        Me.UltraGrid1.Tag = "HRSINPUTLISTING"
        Me.UltraGrid1.Text = "Mileage Input  Listing"
        '
        'GroupBox4
        '
        ...
        Me.Name = "MileageListing"
        Me.Tag = "MileageListingTag"
        Me.Text = "MileageListing"
...
#Region "Common Events"
    ...
    Private Sub MileageListing_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnDisplay_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDisplay.Click
        ...
        Select Case uopCompany.CheckedIndex
            ...
            Case 1 ' By Route
                If utRoute.Text = "" Then
                    _strWhereOrganization = " AND ead.Route = NULL "
                Else
                    _strWhereOrganization = " AND ead.Route = '" & utRoute.Text & "' "
                End If
            Case 2 ' By Office
        ...
        _strCondition = _strWhereOrganization & _strWhereDate & _strWhereEmployee & " order by ead.EmployeeID, ead.CheckInDate asc "
    ...
    Private Sub btnEmployee_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEmployee.Click
        ...
        Select Case uopCompany.CheckedIndex
            Case 1 ' By Route
                ...
                strRoute = utRoute.Text
            Case 2 ' By Office
                iOfficeId = ucboOffice.Value
        End Select

        If cbActiveOnly.Checked Then
            FetchTimeCardEmployees(dtSet, strRoute, iOfficeId)
        Else
            FetchAllTimeCardEmployees(dtSet, strRoute, iOfficeId)
        End If
...
ErrTrap:
    ...
    Private Sub MileageListing_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        If ErrorProvider1.GetError(utEmployeeID).ToString <> "" Or ErrorProvider1.GetError(ucboOffice).ToString <> "" Or ErrorProvider1.GetError(utRoute).ToString <> "" Then
            e.Cancel = False
        End If
    End Sub
...
#Region "Data Access Functions"
    ...
    Private Sub PopulateGrid()
        ...
        If FetchMileageInput(dtSet, _strCondition) Then
...
#Region "Field Validation"
    ...
    Private Sub utRoute_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If ErrorProvider1.GetError(utRoute).ToString <> "" Then
            utRoute.Select()
        End If
    End Sub

    Private Sub utRoute_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        'If Not ValidDivision(ucboDivision.Text) And uopCompany.CheckedIndex = 1 Then
        If uopCompany.CheckedIndex = 1 Then
            SetError(utRoute, e, "Please Enter a Route")
        End If
    End Sub

    Private Sub utRoute_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ClearError(utRoute)
    End Sub
...
#End Region
    ...
    'Private Sub btnTimeVerification_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    'Private Sub btnComplianceCheck_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    'Private Sub btnBreakAnalysis_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
