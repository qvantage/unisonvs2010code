...
Public Class OrderLabelV1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RoutesModule.OrderLabelV1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrderLabelV1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrderLabelV1 = New OrderLabelV1()
        rpt.Site = Me.Site
        Return rpt
    End Function
