...
Public Class SLabelsColor1x4
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RoutesModule.SLabelsColor1x4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSLabelsColor1x4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SLabelsColor1x4 = New SLabelsColor1x4()
        rpt.Site = Me.Site
        Return rpt
    End Function
