...
Public Class SLabelsVer2Hold
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RoutesModule.SLabelsVer2Hold.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSLabelsVer2Hold
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SLabelsVer2Hold = New SLabelsVer2Hold()
        rpt.Site = Me.Site
        Return rpt
    End Function
