...
Public Class Pouch__Container_Barcodes1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Pouch & Container Barcodes.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RoutesModule.Pouch & Container Barcodes.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedPouch__Container_Barcodes1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Pouch__Container_Barcodes = New Pouch__Container_Barcodes()
        rpt.Site = Me.Site
        Return rpt
    End Function
