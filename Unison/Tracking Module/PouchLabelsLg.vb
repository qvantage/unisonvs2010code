...
Public Class PouchLabelsLg
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RoutesModule.PouchLabelsLg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPouchLabelsLg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PouchLabelsLg = New PouchLabelsLg()
        rpt.Site = Me.Site
        Return rpt
    End Function
