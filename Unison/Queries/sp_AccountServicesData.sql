...
Select mft2.rowid, mft2.AccountID, mft2.ID as SID, c.name as AccountName 
...
Select [ID], [Day], ServiceDate as SvcDate, OfficeID as Ofc, RouteNo as Rte, STime as STm, CTime as CTm, StopNo as Stp, Charge as Chg from ServiceSchedules where AccountID = @@AccountID AND SID = @@SID2 Order by ID;
Select mft3.rowid, mft3.AccountID, mft3.ID as SID, c.name as AccountName 
