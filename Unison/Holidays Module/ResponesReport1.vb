...
Public Class ResponesReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RoutesModule.ResponesReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedResponesReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ResponesReport = New ResponesReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
