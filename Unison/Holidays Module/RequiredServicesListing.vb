...
Public Class RequiredServicesListing
    Inherits System.Windows.Forms.Form
    Dim SQLSelect As String = "Select hrte.AccountID, c.Name as Account, hrte.ServiceID as SID " & _
                              " , a.OfficeID, so.Name as Office, hrte.HCharge as Charge, a.CompName AS Location, a.Street, a.CityName as City, a.State, a.ZipCode " & _
                              " FROM (((" & HOLIDAYSTblPath & "HolidayRoutes hrte LEFT OUTER JOIN " & _
                              " " & ROUTESTblPath & "AccountServices a ON hrte.ServiceID = a.ID AND " & _
                              " hrte.AccountID = a.AccountID) LEFT OUTER JOIN " & _
                              " " & AppTblPath & "Customer c ON a.AccountID = c.ID) LEFT OUTER JOIN " & _
                              " " & AppTblPath & "ServiceOffices so ON a.OfficeID = so.ID) " & _
                              " WHERE hrte.HDate = @HDate AND hrte.AccountID @AcctID" & _
                              " ORDER BY a.ID"
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        '
        'RequiredServicesListing
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(792, 425)
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.Panel2, Me.Panel1, Me.GroupBox1})
        Me.Menu = Me.MainMenu1
        Me.Name = "RequiredServicesListing"
        Me.Tag = "RequiredServicesListing"
        Me.Text = "Account Requirements & Charges Listing"
...
#End Region
    ...
    Private Sub RequiredServicesListing_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'Aly's corrent
        'FillCombo(cboHDate, "", "") '" Where year(hdate) in (" & Date.Today.Year & ", " & Date.Today.Year + 1 & ")"
        'Karina's change
    ...
    Private Sub btnPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPreview.Click
        ...
        Catch ex As System.Data.SqlClient.SqlException 'Message modified by Michael Pastor
    ...
    Private Sub Account_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Account.Leave
        ...
        If sender.text.trim = "" Then
            AcctID.Text = ""
            sender.text = ""
        ElseIf SearchOnLeave(sender, AcctID, HOLIDAYSTblPath & "Notices", "AccountID", "AccountName", "", "Accounts Responded", "HDate = '" & cboHDate.Text & "'") Then ' Ali : Why? "NeedService = 1"
