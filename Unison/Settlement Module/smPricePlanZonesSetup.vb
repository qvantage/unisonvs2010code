...
Public Class smPricePlanZonesSetup
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "smPricePlanZonesSetup"
        Me.Tag = "PricePlanZones"
        Me.Text = "Settlement Price Plan Zones Setup"
...
#End Region
    ...
    Private Sub smPricePlanZonesSetup_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub BtnExit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExit.Click
        Me.Close()
    End Sub
    Private Sub smPricePlanZonesSetup_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
    ...
    Private Sub btnAddZip_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddZip.Click
        ...
        Else
            ...
            SQLSelect2 = "Select Convert(bit, 0) as CHK, ZIPCODE from  " & smBILLTblPath & "CITY where STATECODE = '" & Code & "' order by NAME"
                ...
                Finally
                    If HasErr = False Then
                        ...
                        Else
                            ...
                            InsQry = "Insert into " & smBILLTblPath & "PricePlanZoneZip(ZoneID, Zip) Select " & ID & ", ZipCode from " & smBILLTblPath & "City where ZipCode in " & SelZip & " and ZipCode not in (Select Zip from " & smBILLTblPath & "PricePlanZoneZip where ZoneID = " & ID & ")"
                            ExecuteQuery(InsQry)
                        End If
