...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents rbAllAccts As System.Windows.Forms.RadioButton
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim Appearance1 As Infragistics.Win.Appearance = New Infragistics.Win.Appearance
        Me.GroupBox1 = New System.Windows.Forms.GroupBox
        Me.rbAllAccts = New System.Windows.Forms.RadioButton
        ...
        'GroupBox1
        '
        Me.GroupBox1.Controls.Add(Me.rbAllAccts)
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(992, 168)
        Me.GroupBox1.TabIndex = 0
        Me.GroupBox1.TabStop = False
        '
        'rbAllAccts
        '
        Me.rbAllAccts.Location = New System.Drawing.Point(8, 136)
        Me.rbAllAccts.Name = "rbAllAccts"
        Me.rbAllAccts.Size = New System.Drawing.Size(96, 16)
        Me.rbAllAccts.TabIndex = 170
        Me.rbAllAccts.Text = "All Accounts"
        '
        'btnExportDetails
        '
        Me.btnExportDetails.Location = New System.Drawing.Point(792, 128)
        Me.btnExportDetails.Name = "btnExportDetails"
        Me.btnExportDetails.Size = New System.Drawing.Size(152, 21)
        Me.btnExportDetails.TabIndex = 169
        ...
        Me.Panel2.Location = New System.Drawing.Point(118, 98)
        ...
        'btnAcct
        '
        Me.btnAcct.Location = New System.Drawing.Point(360, 8)
        ...
        Me.utAcct.Location = New System.Drawing.Point(8, 8)
        ...
        Me.utAcctID.Location = New System.Drawing.Point(280, 8)
        ...
        'btnExcel
        '
        Me.btnExcel.Location = New System.Drawing.Point(664, 128)
        ...
        'btnPrint
        '
        Me.btnPrint.Location = New System.Drawing.Point(568, 128)
        ...
        'btnDisplay
        '
        Me.btnDisplay.Location = New System.Drawing.Point(472, 128)
        ...
        Me.UltraDate2.Location = New System.Drawing.Point(123, 76)
        ...
        Me.UltraDate1.Location = New System.Drawing.Point(123, 46)
        ...
        'rbInvNo
        '
        Me.rbInvNo.Location = New System.Drawing.Point(8, 106)
        ...
        'rbCloseDate
        '
        Me.rbCloseDate.Location = New System.Drawing.Point(8, 76)
        ...
        'rbInvDate
        '
        Me.rbInvDate.Location = New System.Drawing.Point(8, 46)
        ...
        'rbAcct
        '
        Me.rbAcct.Location = New System.Drawing.Point(8, 16)
        ...
        Me.UltraGrid1.Location = New System.Drawing.Point(0, 168)
        Me.UltraGrid1.Name = "UltraGrid1"
        Me.UltraGrid1.Size = New System.Drawing.Size(992, 120)
        Me.UltraGrid1.TabIndex = 144
        ...
        Me.Splitter1.Location = New System.Drawing.Point(0, 288)
        Me.Splitter1.Name = "Splitter1"
        Me.Splitter1.Size = New System.Drawing.Size(992, 8)
        Me.Splitter1.TabIndex = 145
        Me.Splitter1.TabStop = False
        '
        'UltraGrid2
        '
        Me.UltraGrid2.Dock = System.Windows.Forms.DockStyle.Fill
        Me.UltraGrid2.Location = New System.Drawing.Point(0, 296)
        Me.UltraGrid2.Name = "UltraGrid2"
        Me.UltraGrid2.Size = New System.Drawing.Size(992, 177)
        Me.UltraGrid2.TabIndex = 146
        Me.UltraGrid2.Tag = "TrackingListing"
        Me.UltraGrid2.Text = "Invoice Details"
        '
        ...
        Me.Name = "smInvoiceListing"
        Me.Text = "Settlement Listing"
...
#End Region
    ...
    Private Sub smInvoiceListing_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.CenterToScreen()
        ...
        UltraGrid2.Text = "Invoice Details"
        ...
        Select Case rbCurrIdx
            ...
            Case 1 ' InvDate
                If UltraDate1.Value Is Nothing Then
                    ...
                    Exit Sub
                End If
                Cond = " i.Invoice_Date between '" & UltraDate1.Text & " 00:00:00.000' and '" & UltraDate1.Text & " 23:59:59.999'"
            Case 2 ' ClDate
    ...
    Private Sub btnExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExcel.Click, btnExportDetails.Click
...
ErrLabel:
    ...
    Private Sub rbAcct_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rbAcct.CheckedChanged, rbCloseDate.CheckedChanged, rbInvDate.CheckedChanged, rbInvNo.CheckedChanged, rbAllAccts.CheckedChanged
    ...
    Private Sub LoadData2()
        ...
        'SQLSelect = "Select ili.Invoice_No, mft.TrackingNum, mft.ToLocID, mft.ToLocName, mft.ToCity, mft.ToState, mft.ToZip, ili.TranDate, ili.Description, ili.Qty, ili.Unit, ili.Charge from " & smBILLTblPath & "InvoiceLineItems ili left outer join " & TRCTblPath & "Manifest mft on ili.MftRowID = mft.RowID " & _
        '             " where (ili.invoice_No = @INVNO) AND ili.charge is not NULL order by LineNum; "
        SQLSelect = "Select Invoice_No, TrackingNum, " & _
            "CASE WHEN ToLocID IS NULL THEN gToLocID ELSE ToLocID END as ToLocID, " & _
            "CASE WHEN ToLocName IS NULL THEN gToLocName ELSE ToLocName END as ToLocName, " & _
            "CASE WHEN ToCity IS NULL THEN gToCity ELSE ToCity END as ToCity, " & _
            "CASE WHEN ToState IS NULL THEN gToState ELSE ToState END as ToState, " & _
            "CASE WHEN ToZip IS NULL THEN gToZip ELSE ToZip END as ToZip, " & _
            "TranDate, Description, Qty, Unit, Charge " & _
            "from " & smBILLTblPath & "InvoiceDetailsView " & _
                     " where (invoice_No = @INVNO) AND charge is not NULL order by LineNum; "
