...
Public Class smPricePlanSetup
    ...
    Dim sqlPricePlanEdit As String = _
            ...
            " pp.From_Zone, " & _
            " pp.To_Zone, " & _
            " pp.Start_Date, pp.End_Date, pp.ModuleName, pp.TableName, pp.ColumnTitle, pp.ColumnName, pp.ColumnPrefix, pp.ColumnSuffix, pp.OverLimit_Charge, pp.Taxable, pp.PerLocationID, " & _
            " pp.Invoice_Title, pp.Description " & _
            " from " & smBILLTblPath & "PricePlans pp "
    ...
    Dim SQLSelectAddCond As String = _
        ...
        "From " & smBILLTblPath & "PricePlanCondition ppc left outer join " & smBILLTblPath & "PricePlanConditionOperators ppco" & _
    ...
    Dim SQLSelectEdit As String = "Select PlanID, Plan_Name, PlanTypeCode, Charge_Code," & _
        ...
        "PerLocationID from " & smBILLTblPath & "PricePlans"
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.ucboPlanType.Location = New System.Drawing.Point(264, 48)
        Me.ucboPlanType.Name = "ucboPlanType"
        Me.ucboPlanType.Size = New System.Drawing.Size(100, 21)
        ...
        Me.utPlanName.Size = New System.Drawing.Size(200, 21)
        Me.utPlanName.TabIndex = 0
        Me.utPlanName.Tag = ".Plan_Name"
        '
        'Label13
        '
        Me.Label13.Location = New System.Drawing.Point(184, 128)
        ...
        Me.umskEndDate.Location = New System.Drawing.Point(248, 128)
        ...
        Me.utModuleName.Location = New System.Drawing.Point(464, 40)
        ...
        Me.utTableName.Location = New System.Drawing.Point(464, 64)
        Me.utTableName.MaxLength = 15
        Me.utTableName.Name = "utTableName"
        Me.utTableName.ReadOnly = True
        Me.utTableName.Size = New System.Drawing.Size(150, 21)
        ...
        Me.utColumnTitle.Location = New System.Drawing.Point(464, 16)
        ...
        Me.utColumnPrefix.Location = New System.Drawing.Point(464, 96)
        ...
        Me.utColumnSuffix.Location = New System.Drawing.Point(616, 96)
        ...
        'Label10
        '
        Me.Label10.Location = New System.Drawing.Point(384, 64)
        ...
        'Label8
        '
        Me.Label8.Location = New System.Drawing.Point(384, 96)
        ...
        'cbPerDay
        '
        Me.cbPerDay.Location = New System.Drawing.Point(152, 176)
        Me.cbPerDay.Name = "cbPerDay"
        Me.cbPerDay.Size = New System.Drawing.Size(64, 24)
        ...
        Me.utPlanID.Location = New System.Drawing.Point(304, 16)
        ...
        'cbTaxable
        '
        Me.cbTaxable.Location = New System.Drawing.Point(288, 160)
        Me.cbTaxable.Name = "cbTaxable"
        Me.cbTaxable.Size = New System.Drawing.Size(64, 20)
        ...
        'Label12
        '
        Me.Label12.Location = New System.Drawing.Point(368, 160)
        ...
        'Label11
        '
        Me.Label11.Location = New System.Drawing.Point(336, 128)
        ...
        Me.utInvoiceSelTitle.Location = New System.Drawing.Point(464, 128)
        Me.utInvoiceSelTitle.MaxLength = 40
        Me.utInvoiceSelTitle.Name = "utInvoiceSelTitle"
        Me.utInvoiceSelTitle.Size = New System.Drawing.Size(200, 21)
        ...
        Me.utDescription.Location = New System.Drawing.Point(464, 152)
        ...
        Me.utOverLimit_Charge.Size = New System.Drawing.Size(48, 21)
        ...
        Me.Label18.Location = New System.Drawing.Point(0, 160)
        ...
        'cbPerLocation
        '
        Me.cbPerLocation.Location = New System.Drawing.Point(152, 160)
        ...
        Me.Name = "smPricePlanSetup"
        Me.Tag = "PricePlanSetup"
        Me.Text = "Settlement Price Plan Setup"
...
#End Region
    ...
    Private Sub smPricePlanSetup_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not GroupBox3.Tag Is Nothing Then
            If GroupBox3.Tag <> "" Then
                GroupBox3.Tag = smBILLTblPath & GroupBox3.Tag
            End If
        End If
        If Not gbConds.Tag Is Nothing Then
            If gbConds.Tag <> "" Then
                gbConds.Tag = smBILLTblPath & gbConds.Tag
            End If
        End If
        ...
        FillUCombo(ucboPlanType, "", , , smBILLTblPath)

        AddHandler ucboChargeCode.Leave, AddressOf UCbo_Leave
        FillUCombo(ucboChargeCode, "", , , smBILLTblPath)

        AddHandler ucboOperator.Leave, AddressOf UCbo_Leave
        FillUCombo(ucboOperator, "", , , smBILLTblPath)

        'FillUCombo(ucboField, "", "", "Select modulename, tablename, columnname, columntitle, columnprefix, columnsuffix from " & smBILLTblPath & "priceplanmodules ")
    ...
    Private Sub LoadData(Optional ByVal PlanID As Int32 = 0)
        ...
        Dim sqlPricePlan As String = _
                ...
                " pp.Invoice_Title, pp.Description " & _
                " from " & smBILLTblPath & "PricePlans pp left outer join " & smBILLTblPath & "PricePlanZones ppzfrom on ppzfrom.ZoneID = pp.From_Zone " & _
                " left outer join " & smBILLTblPath & "PricePlanZones ppzto on  ppzto.ZoneID=pp.To_Zone " & _
                " "
    ...
    Private Sub utFromZone_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles utFromZone.KeyUp, utToZone.KeyUp, utColumnTitle.KeyUp
        If utColumnTitle.ContainsFocus = True Then
            TypeAhead(sender, e, smBILLTblPath & "PricePlanModules", "ColumnTitle")
        Else
            TypeAhead(sender, e, smBILLTblPath & "PricePlanZones", "Zone_Name")
        End If
    End Sub
    Private Sub utFromZone_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles utFromZone.Leave, utToZone.Leave, utColumnTitle.Leave
        ...
        If utColumnTitle.ContainsFocus = True Then
            If SearchOnLeave(sender, utColumnTitle, smBILLTblPath & "PricePlanModules", "RowId", "ColumnTitle", "*") Then
                If ReturnRowByID(utColumnTitle.Text, row, smBILLTblPath & "PricePlanModules", , "RowID") Then
        ...
        Else
            If utFromZone.ContainsFocus = True Then
                If SearchOnLeave(sender, utFromZoneID, smBILLTblPath & "PricePlanZones", "ZoneID", "Zone_Name", "*") Then
                    utToZone.Focus()
                    Exit Sub
                Else
                    utFromZone.Text = ""
            ...
            End If
            If utToZone.ContainsFocus = True Then
                If SearchOnLeave(sender, utToZoneID, smBILLTblPath & "PricePlanZones", "ZoneID", "Zone_Name", "*") Then
                    udStartDate.Focus()
                    Exit Sub
                Else
                    utToZone.Text = ""
    ...
    Public Function FillUltraGrid2(ByVal PlanID As Integer)
        ...
        Dim HidCols() As String
        Dim SQLSelect2 As String '= "Select From_Range, To_Range, Charge From " & smBILLTblPath & "PricePlanCharges where PlanID = " & PlanID & " Order by From_Range"
        ...
        Select Case PlanType
            Case "F"
                SQLSelect2 = "Select RowID, " & PlanID & " as PlanID, Charge from " & smBILLTblPath & "PricePlanCharges where PlanID = " & PlanID & " Order by Charge"
            ...
            Case "R"
                SQLSelect2 = "Select RowID, PlanID, From_Range, To_Range, Charge From " & smBILLTblPath & "PricePlanCharges where PlanID = " & PlanID & " Order by From_Range"
                UltraGrid2.DisplayLayout.Override.AllowAddNew = Infragistics.Win.DefaultableBoolean.Default 'Karina added
    ...
    Public Function FillUltraGrid3(ByVal PlanID As Integer)
        Dim dS As New DataSet
        Dim dA As New SqlDataAdapter
        'Dim SQLSelect3 As String '= "Select From_Range, To_Range, Charge From " & smBILLTblPath & "PricePlanCharges where PlanID = " & PlanID & " Order by From_Range"
        ...
        '            "from " & smBILLTblPath & "PricePlanCondition ppc " & _
        '            "where ppc.PlanID = "
        '            "left outer join " & smBILLTblPath & "PricePlans pp " & _

        '            "on pp.PlanID = ppc.PlanID where " smBILLTblPath "@PLANID Order by ModuleName"
        ...
        SQLSelect3 = "Select ppc.RowID, ppc.PlanID, ppc.ModuleName, ppc.TableName, ppc.ColumnName, ppc.ColumnTitle, ppc.Operator, ppc.[Values] " & _
            "from " & smBILLTblPath & "PricePlanCondition ppc where @PLANID Order by ModuleName"
        'SQLSelect3 = "Select ppc.RowID, ppc.PlanID, ppc.ModuleName, ppc.TableName, ppc.ColumnName, ppc.ColumnTitle, ppc.Operator, ppc.[Values] " & _
        '            "from " & smBILLTblPath & "PricePlanCondition ppc " & _
        '            "left outer join " & smBILLTblPath & "PricePlans pp " & _
    ...
    Private Sub btnSelFromZ_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelFromZ.Click, btnSelectToZ.Click, btnSelModName.Click
        ...
        If btnSelModName.Focused = True Then
            SelectSQL2 = "Select RowID, ModuleName, TableName, ColumnTitle, ColumnName, ColumnPrefix, ColumnSuffix from " & smBILLTblPath & "PricePlanModules order by ModuleName, Tablename, ColumnTitle"
            PopulateDataset2(dtAdapter, dtSet, SelectSQL2)
        Else
            SelectSQL = "Select * from  " & smBILLTblPath & "PricePlanZones order by Zone_Name"
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        ...
        End If
    End Sub
    Private Sub smPricePlanSetup_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
    ...
    '    updCmd = New SqlCommand("Update " & smBILLTblPath & "PricePlanCharges Set PlanID = @Pid, From_Range = @Frg, To_Range = @Trg, Charge = @Crg")
    '    'Dim UpdCmd As SqlCommand
    '    'UpdCmd = New SqlCommand("Update " & smBILLTblPath & "PricePlanCharges Set PlanID = @Pid, From_Range = @Frg, To_Range = @Trg, Charge = @Crg)
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Dim SQLSelectAdd As String = "Insert into " & smBILLTblPath & "PricePlanCondition(PlanID, ModuleName, TableName, ColumnName, ColumnTitle, Operator, [Values]) " & _
    ...
    Private Sub btnRemove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemove.Click
        Dim ugrow As Infragistics.Win.UltraWinGrid.UltraGridRow
        Dim SQLDelete As String = "Delete from " & smBILLTblPath & "PricePlanCondition " & _
    ...
    Private Function SavePlanCharges(ByVal PlanID As String, ByVal PlanTypeCode As String)
        ...
        Dim sqlFixedCharge As String = "Select RowID, PlanID, Charge from " & smBILLTblPath & "PricePlanCharges where PlanID = " & PlanID
        Dim sqlFixedChargeUpdate As String = "Update " & smBILLTblPath & "PricePlanCharges Set Charge = @CHRG, From_Range = @FRANGE, To_Range = @TRANGE where RowID = @ROWID"
        Dim sqlFixedChargeInsert As String = "Insert Into " & smBILLTblPath & "PricePlanCharges(PlanID, From_Range, To_Range, Charge) Values(@PlanID,@FRANGE, @TRANGE, @CHRG) "
        Dim i As Int32 = 0
        Dim da As New SqlDataAdapter
        ...
        '    Dim sqlInsert As String = "Insert into " & smBILLTblPath & "PricePlanCharges(PlanID, From_Range, To_Range, Charge) Select '" & dschg.Tables(0).Rows(i)("Charge")
        'End If
    ...
    Private Sub cbPerLocation_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbPerLocation.CheckedChanged
        If cbPerLocation.Checked = True Then cbPerDay.Enabled = False Else cbPerDay.Enabled = True
    End Sub

    Private Sub cbPerDay_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbPerDay.CheckedChanged
        If cbPerDay.Checked = True Then cbPerLocation.Enabled = False Else cbPerLocation.Enabled = True
    End Sub
End Class
