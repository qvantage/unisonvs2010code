...
Public Class smInvoiceChargeDistribution
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "smInvoiceChargeDistribution"
...
#End Region
    ...
    Private Sub smInvoiceChargeDistribution_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.CenterToScreen()
    ...
    Private Sub LoadData()
        ...
        '             " from " & smBILLTblPath & "InvoiceLineItems ili left outer join " & TRCTblPath & "Manifest mft on ili.MftRowID = mft.RowID " & _
...
ErrLabel:
    ...
    Private Sub LoadData2()
        ...
        SQLSelect = "Select b.BranchID, b.Name, 'Freight Charge' as Description, Sum(ili.Qty) as Qty, ili.Unit as Unit, sum(ili.Charge) as BranchTotal" & _
                     ...
                     " left outer join " & smBILLTblPath & "Branch b on dz.BranchID = b.BranchID " & _
                     " where ili.invoice_No = @INVNO " & _
                     " AND ili.charge is not NULL and ili.mftrowid is not null " & _
                     ...
                     " from " & smBILLTblPath & "InvoiceLineItems ili " & _
                     " left outer join " & smBILLTblPath & "Location tloc on ili.ToAddID = tloc.Addressid " & _
