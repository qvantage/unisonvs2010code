...
#End Region
    ...
    Private Sub smInvoiceDelete_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.CenterToScreen()
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        If MsgBox("Are you sure to delete invoice number " & UltraGrid1.ActiveRow.Cells("Invoice_No").Value & "?", MsgBoxStyle.Exclamation.YesNo) = MsgBoxResult.Yes Then
            ...
            If x.DialogResult = DialogResult.OK Then
                ...
                Dim qInvDelete As String = smBILLTblPath & "DeleteInvoice " & InvNo & ", 'TRACKING', '" & smBILLTblPath & "', '" & TRCTblPath & "'"
