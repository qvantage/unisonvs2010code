...
Public Class smPricePlanModules
    Inherits System.Windows.Forms.Form
 
    Dim SQLSelect As String = "Select RowId, ModuleName, TableName, ColumnTitle, ColumnName, ColumnPrefix, ColumnSuffix From " & smBILLTblPath & " PricePlanModules"
    'Dim SQLSelect As String = "Select ModuleName, TableName, ColumnName, ColumnPrefix, ColumnSuffix From " & smBILLTblPath & " PricePlanModules"
    'Dim SLQSelSave As String = "Select ModuleName, TableName, ColumnName, ColumnPrefix, ColumnSuffix From " & smBILLTblPath & " PricePlanModules"
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "smPricePlanModules"
        Me.Tag = "PricePlanModules"
        Me.Text = "Settlement Price Plan Modules"
...
#End Region
    ...
    Private Sub smPricePlanModules_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Dim QueryExec As String = "Delete from " & smBILLTblPath & "PricePlanModules where RowId = '" & RowID & "'"
