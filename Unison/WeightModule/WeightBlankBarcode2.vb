...
Public Class WeightBlankBarcode2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RoutesModule.WeightBlankBarcode.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedWeightBlankBarcode1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WeightBlankBarcode = New WeightBlankBarcode()
        rpt.Site = Me.Site
        Return rpt
    End Function
