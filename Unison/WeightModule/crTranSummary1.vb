...
Public Class crTranSummary1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RoutesModule.crTranSummary.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedcrTranSummary1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crTranSummary = New crTranSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
