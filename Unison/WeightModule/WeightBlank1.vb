...
Public Class WeightBlank1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RoutesModule.WeightBlank.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedWeightBlank1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WeightBlank = New WeightBlank()
        rpt.Site = Me.Site
        Return rpt
    End Function
