...
Public Class WeightTotals_CR9_All_WPGs_UNISON1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "WeightTotals-CR9-All WPGs_UNISON.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RoutesModule.WeightTotals-CR9-All WPGs_UNISON.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedWeightTotals_CR9_All_WPGs_UNISON1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WeightTotals_CR9_All_WPGs_UNISON = New WeightTotals_CR9_All_WPGs_UNISON()
        rpt.Site = Me.Site
        Return rpt
    End Function
