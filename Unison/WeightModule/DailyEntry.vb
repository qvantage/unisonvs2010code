...
Public Class DailyEntry
    ...
    '                  " left join " & WeightVars.WEIGHTTblPath & "WeightBreakdown wbd on wbd.id =mft.weightid   left join " & AppTblPath & "Customer c on c.id=mft.accountid " & _
    '                 " left join" & AppTblPath & "ServiceOffices so on so.id=mft.officeid left join " & WeightVars.WEIGHTTblPath & " wgtgrp  on  wgtgrp.ID =mft.GroupID " & _
    '                   " WHERE  c.status = 1" & _
    '                  " AND (mft.StartDate <= @TranDate or mft.StartDate is NULL) and ( mft.enddate >= @TranDate or mft.EndDate is NULL) " & _
    '                  " ORDER BY c.name " ', '0.00' as Weight 
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.TotalWeight.Location = New System.Drawing.Point(592, 56)
        ...
        'btnRun
        '
        Me.btnRun.Location = New System.Drawing.Point(344, 56)
        ...
        'btnGroup
        '
        Me.btnGroup.Location = New System.Drawing.Point(344, 24)
        ...
        'GroupID
        '
        Me.GroupID.Location = New System.Drawing.Point(480, 24)
        ...
        'Label16
        '
        Me.Label16.Location = New System.Drawing.Point(80, 24)
        ...
        Me.Group.Location = New System.Drawing.Point(152, 24)
        Me.Group.Name = "Group"
        ...
        'Label5
        '
        Me.Label5.Location = New System.Drawing.Point(88, 59)
        ...
        'DTPicker1
        '
        Me.DTPicker1.Location = New System.Drawing.Point(152, 56)
        ...
        Me.GroupBox2.Size = New System.Drawing.Size(712, 40)
        Me.GroupBox2.TabIndex = 2
        Me.GroupBox2.TabStop = False
        '
        'btnSaveLayout
        '
        Me.btnSaveLayout.Location = New System.Drawing.Point(416, 16)
        ...
        'btnFinalize
        '
        Me.btnFinalize.Location = New System.Drawing.Point(304, 16)
        ...
        Me.btnExit.Location = New System.Drawing.Point(624, 16)
        ...
        Me.UltraGrid1.Size = New System.Drawing.Size(712, 400)
...
ErrTrap:
    ...
    Private Sub btnFinalize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFinalize.Click
        ...
        If UpdateDbFromDataSet(dtSet, SQLSelect & " Where de.WeightPlanGroupID = " & GroupID.Text & " AND TranDate = '" & Format(DTPicker1.Value, "MM/dd/yyyy") & "' ORDER BY AccountName") <= 0 Then
            'MsgBox("btnDelete_Click: Error!")
        End If
        NewTrans = False
        sender.focus()
        ...
        SQLString = "Update " & WeightVars.WEIGHTTblPath & "dailyentry set Finalize = 1 Where WeightPlanGroupID = " & GroupID.Text & " AND TranDate = '" & Format(DTPicker1.Value, "MM/dd/yyyy") & "' AND WeightPlanGroupID = " & GroupID.Text
...
ErrTrap:
    ...
    Private Function IsFinalized() As Boolean
        ...
        Cmd = New SqlCommand("Select Finalize FROM " & WeightVars.WEIGHTTblPath & "DailyEntry de where de.WeightPlanGroupID = " & GroupID.Text & " AND TranDate = '" & Format(DTPicker1.Value, "MM/dd/yyyy") & "'", sqlConn)
        ...
        If dr.Read() = True Then
            ...
            '    " WHERE WeightPlanGroupID = " & GroupID.Text & " AND trandate = '" & Format(DTPicker1.Value, "MM/dd/yyyy") & "' AND manifestid IN (SELECT id FROM " & WeightVars.WEIGHTTblPath & "manifests) "
        ...
        Else
            dr.Close()
            Cmd.Connection.Close()
            SelectTmp2 = "Select '" & Format(DTPicker1.Value, "MM/dd/yyyy") & "' as TranDate, " & SQLInsSelect
            SelectTmp2 = SelectTmp2.Replace("@TranDate", "'" & Format(DTPicker1.Value, "MM/dd/yyyy") & "'")
...
ErrTrap:
    ...
    Private Function InsertNewPlans()
        ...
        SelectNew = PrepSelectQuery(SelectTmp2, SQLInsertNewMft & " WHERE WeightPlanGroupID = " & GroupID.Text & " AND trandate = '" & Format(DTPicker1.Value, "MM/dd/yyyy") & "') AND mft.groupid = " & GroupID.Text)
