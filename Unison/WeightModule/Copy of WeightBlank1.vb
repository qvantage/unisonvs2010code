...
Public Class Copy_of_WeightBlank
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Copy of WeightBlank.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RoutesModule.Copy of WeightBlank.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCopy_of_WeightBlank
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Copy_of_WeightBlank = New Copy_of_WeightBlank()
        rpt.Site = Me.Site
        Return rpt
    End Function
