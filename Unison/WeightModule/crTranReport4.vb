...
Public Class crTranReport4
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RoutesModule.crTranReport4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrTranReport4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crTranReport4 = New crTranReport4
        rpt.Site = Me.Site
        Return rpt
    End Function
